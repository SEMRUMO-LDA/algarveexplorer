  ...
  return (
    <section className={`relative ${heightClass} flex flex-col justify-end overflow-hidden bg-white`}>
      ...
      >
        ...
        {/* Title */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold font-montserrat text-white leading-[1.05] tracking-tight uppercase max-w-5xl mb-6 drop-shadow-xl">
          {title}
          {subtitle && (
            <>
              <br />
