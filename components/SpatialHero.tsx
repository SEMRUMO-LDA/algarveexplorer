...
import SpatialParallax from '@/components/SpatialParallax';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 w-full pb-16 md:pb-24 z-50 relative">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-8xl font-montserrat font-bold text-white mb-8 tracking-tighter leading-[0.9] uppercase">
          {title}
        </h1>
        {description && (
