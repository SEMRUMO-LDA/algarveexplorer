  ...
  if (!tour) {
    return (
      <div className="pt-32 px-6 text-center min-h-screen bg-[#fdfdfb] flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold font-montserrat text-[#0d4357] mb-6">Experience Not Found</h1>
        <Link to="/tours" className="bg-[#da6927] text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest text-xs">Back to all tours</Link>
      </div>
    );
  }
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-10">
                   ...
                   <div className="flex space-x-3 pb-2">
                      <button 
                        ...
                        className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-[#0d4357]/10 flex items-center justify-center text-[#0d4357] hover:bg-[#0d4357] hover:text-white transition-all bg-white shadow-sm"
                      >
                        <ChevronLeft size={20} />
                      </button>
                      <button 
              ...
              <div className="sticky top-[20%] z-20 transition-all duration-300">
                <div className="bg-[#fcfcf9] p-10 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <Link to="/contacts" className="flex items-center justify-center space-x-3 w-full bg-[#0d4357] hover:bg-[#da6927] text-white py-6 rounded-full font-bold uppercase tracking-[0.2em] text-[11px] transition-all shadow-md group/btn">
                      <span>{language === 'pt' ? 'RESERVAR LUGAR' : 'RESERVE MY SPOT'}</span>
                      <ArrowRight size={14} className="group-hover/btn:translate-x-1 transition-transform" />
                    </Link>
                    <button className="flex items-center justify-center space-x-3 w-full bg-white text-[#0d4357]/40 py-6 rounded-full font-bold text-[11px] uppercase tracking-[0.2em] border border-slate-100 hover:bg-[#0d4357] hover:text-white transition-all shadow-sm">
                      <Download size={14} />
